...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        gold: "0 0 30px rgba(184, 150, 46, 0.25)",
        "gold-lg": "0 20px 60px -15px rgba(184, 150, 46, 0.3)",
        "card-hover": "0 25px 60px -10px rgba(0,0,0,0.5), 0 0 30px rgba(184, 150, 46, 0.15)",
      },
      backgroundImage: {
        "gradient-gold": "linear-gradient(135deg, #B8962E 0%, #D4AF6A 50%, #B8962E 100%)",
        "gradient-dark": "linear-gradient(135deg, #080808 0%, #111111 100%)",
        "gradient-card": "linear-gradient(180deg, #161616 0%, #111111 100%)",
        "hero-overlay": "linear-gradient(to bottom, rgba(8,8,8,0.55) 0%, rgba(8,8,8,0.4) 40%, rgba(8,8,8,0.75) 80%, rgba(8,8,8,1) 100%)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
