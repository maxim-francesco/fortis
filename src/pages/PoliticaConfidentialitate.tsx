...
export default function PoliticaConfidentialitate() {
  ...
  return (
    <div className="min-h-screen bg-[#080808] pb-20">
      <SEO 
        title="Politica de Confidențialitate | MEDFIL Automobile" 
        description="Politica de confidențialitate a platformei MEDFIL Automobile privind prelucrarea datelor cu caracter personal."
        canonical="https://medfil.ro/politica-de-confidentialitate"
      />
      {/* Hero Header */}
