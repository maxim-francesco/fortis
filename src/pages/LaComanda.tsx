...
import { Clock, ChevronRight, Network, Tag, Search } from "lucide-react";
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input className="w-full bg-[#111] border border-[rgba(184,150,46,0.2)] text-[#F5F5F0] font-body text-sm px-4 py-3 rounded-sm outline-none focus:border-[#B8962E] transition-colors min-h-[48px]" placeholder="ex: BMW, Mercedes, Audi..." />
              </div>
              <div>
                <label className="font-label text-[10px] text-[#888880] tracking-widest block mb-2">MODEL DORIT</label>
                <input className="w-full bg-[#111] border border-[rgba(184,150,46,0.2)] text-[#F5F5F0] font-body text-sm px-4 py-3 rounded-sm outline-none focus:border-[#B8962E] transition-colors min-h-[48px]" placeholder="ex: Seria 5, E-Class, A6..." />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="number" className="w-full bg-[#111] border border-[rgba(184,150,46,0.2)] text-[#F5F5F0] font-body text-sm px-4 py-3 rounded-sm outline-none focus:border-[#B8962E] transition-colors min-h-[48px]" placeholder="ex: 35000" />
              </div>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Diesel", "Benzină", "Hybrid", "Electric", "Oricare"].map((f) => (
                  <label key={f} className="flex items-center gap-2 border border-[rgba(184,150,46,0.2)] px-3 py-2 rounded-sm cursor-pointer hover:border-[#B8962E] transition-colors min-h-[44px]">
                    <input type="checkbox" className="accent-[#B8962E]" />
              ...
              <div className="flex flex-wrap gap-2">
                {["Automată", "Manuală", "Oricare"].map((t) => (
                  <label key={t} className="flex items-center gap-2 border border-[rgba(184,150,46,0.2)] px-3 py-2 rounded-sm cursor-pointer hover:border-[#B8962E] transition-colors min-h-[44px]">
                    <input type="radio" name="transmission" className="accent-[#B8962E]" />
            ...
            <div>
              ...
              <textarea rows={3} className="w-full bg-[#111] border border-[rgba(184,150,46,0.2)] text-[#F5F5F0] font-body text-sm px-4 py-3 rounded-sm outline-none focus:border-[#B8962E] transition-colors resize-none" placeholder="Alte detalii sau preferințe..." />
            </div>
