      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <m.div
            ...
            className="bg-[#161616] border border-[rgba(184,150,46,0.15)] rounded-sm overflow-hidden"
            style={{ height: "450px" }}
          >
            <iframe
          ...
          >
            <div className="p-8 bg-[#111] border border-[rgba(184,150,46,0.2)] rounded-sm shadow-gold group hover:border-[rgba(184,150,46,0.4)] transition-colors">
              ...
              <p className="font-body text-[#888880] mb-2 text-lg">Strada Oașului 134a</p>
              <p className="font-body text-[#888880] text-sm mb-1">Cartier Iris, Cluj-Napoca</p>
              <p className="font-body text-[#888880] text-sm">România</p>
            </div>
            ...
            <div className="p-8 bg-[#111] border border-[rgba(184,150,46,0.2)] rounded-sm shadow-gold group hover:border-[rgba(184,150,46,0.4)] transition-colors">
              ...
              <p className="font-body text-[#888880] text-sm">Luni–Sâmbătă: 09:00–18:00</p>
              <p className="font-body text-[#888880] text-sm">Duminică: Închis</p>
            </div>
