    ...
    <>
      ...
      <div className="lg:hidden sticky-cta flex gap-3 pb-safe">
        <a
          ...
          aria-label="Sună la 0754 299 199"
        >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 border border-[#B8962E] text-[#B8962E] font-body font-semibold text-sm py-3 rounded-sm hover:bg-[rgba(184,150,46,0.1)] transition-colors"
          aria-label="Contactează-ne pe WhatsApp la numărul 0754 299 199"
        >
      ...
      <m.a
        ...
        aria-label="Contactează-ne pe WhatsApp la numărul 0754 299 199 lg"
      >
        <svg aria-hidden="true" width="26" height="26" viewBox="0 0 24 24" fill="white">
